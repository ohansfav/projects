...
class AuthLibrary
{
    ...
    public function LoginUser($email, $rememberMe)
    {
        ...
        if ($user['blocked'] == 1) {
            ...
            // ACCOUNT NOT ACTIVATED SO SET LINK TO RESEND ACTIVATION EMAIL
            $this->Session->setFlashdata('danger', lang('Auth.accountBlocked'));
            return false;
        }
        ...
        //SET USER SESSION 
        $this->setsys_usersession($user);
        $this->Session->setFlashdata('success', "Access granted, signing you in.");
        rat("Signed in");
    }
    ...
    public function RegisterUser($userData)
    {
        ...
        //auto add user to department
        if (isset($_SESSION['department_id']) && isset($_SESSION['station_id'])) {

            $user_dept_model = new \App\Models\UserDepartmentModel();
            $user_dept_model->add_staff_to_department($user['id'], $_SESSION['department_id'], $_SESSION['station_id']);
        }
        ...
        // IF WERE NOT SENDING AN ACTIVATION EMAIL LETS SET THE USER TO ACTIVATED NOW
            ...
            rat("Registered a user data - " . json_encode($data));
     ...
     * @return void
     */
    public function setsys_usersession($user)
    {
        $data = [
            'id' => $user['id'],
    ...
    public function loginlog()
    {
        ...
        if ($this->Session->get('isLoggedIn')) {
            ...
            // BUILD DATA TO ADD TO sys_auth_logins TABLE
            $logdata = [
    ...
    public function rememberMe($userID)
    {
        ...
        // if a selector (id) is found in the sys_auth_tokens table we then match the validators
        //
     ...
     * if we find one w echeck it against our sys_auth_tokens table and see
    ...
    public function checkCookie()
    {
        ...
        // SET USER SESSION
        $this->setsys_usersession($user, '1');
    ...
    public function autoredirect()
    {
        ...
        if (isset($redirect[$this->Session->get('role')])) {
