...
<form method="post" action="<?php echo base_url() . 'addbook' ?>" enctype="multipart/form-data">
	<div class="row gtr-uniform">
		...
		<div class="col-12">
			<label for="bookfile">Upload Book</label>
			 <input type="file" class="form-control" id="bookfile" name="bookfile" accept=".docx,.pdf" required />			 
		</div>
