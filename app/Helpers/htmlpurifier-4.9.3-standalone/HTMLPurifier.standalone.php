 ...
 *
 * However, most sys_users will only need to interface with the HTMLPurifier
 ...
 * @todo Create a separate maintenance file advanced sys_users can use to
 ...
 * edited by sys_userspace code to tweak the behavior of HTMLDefinition.
 *
...
class HTMLPurifier_AttrDef_URI_Host extends HTMLPurifier_AttrDef
{
    ...
    public function validate($string, $config, $context)
    {
        ...
        // so force sys_users to insert Punycode.
 ...
 * @warning sys_users will commonly use <embed> to cater to legacy browsers: this
 ...
 * be safe, and untrusted sys_users can be allowed to embed arbitrary flash objects
