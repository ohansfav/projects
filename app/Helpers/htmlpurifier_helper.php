...
if (!function_exists('html_purify')) {
    ...
    {
        require_once 'htmlpurifier-4.9.3-standalone/HTMLPurifier.standalone.php';
        ...
        if (is_array($dirty_html)) {
            ...
            switch ($config) {
                case 'comment':
                    ...
                    $config->set('HTML.Allowed', 'p,a[href|title],abbr[title],acronym[title],b,strong,blockquote[cite],code,em,i');
                ...
                case false:
                    ...
                    $config->set('HTML' , 'Doctype', 'XHTML 1.0 Strict');
                    $config->set('HTML', 'ForbiddenAttributes', '*@style,*@class,*@onmouseout,*@onclick,*@onmouseover');
                    break;
