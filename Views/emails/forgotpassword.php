                            ...
                            <tr>
                                <td height="50" style="padding:20px;line-height:50px;" >
                                    <p style="text-align:center">
                                        <img src='<?= base_url() ?>/splash/images/logofmcsite.png' alt="Logo" title="Logo" height='auto' width='150' />
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td align="" valign="middle" class="MsoNormal" style="color:#555555; font-family:Segoe UI, Arial, Verdana, Trebuchet MS, sans-serif; font-size:16px; font-weight:300; line-height:24px; letter-spacing:1px;">
                                                    ...
                                                    <p>Forgot your password? It happens, click the link below to reset your password.</p>
                                                    <p style="text-align:center">
                                                        <br><a class="button" style="border-radius:8px; text-decoration:none; color:#333; border:solid #ccc 2px; background:#eceff4;padding:16px;" href="<?= $resetlink ?>">
                                                            RESET PASSWORD</a>
                                                    </p><br>
                                                    <p>Or copy and paste: <span style="color:#2b8a3e"><?= $resetlink ?></span> into your browser's address bar.</p>
                                                    <p>If you did not request your password, please ignore this email, the request will be deactivated in 1 hour</p>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td align="center" class="MsoNormal" style="color:#666666; font-family:Segoe UI, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; font-weight:300; line-height:24px; letter-spacing:1px;">
                                                                    &copy; <?= "2021" . (date("Y") > 2021 ? "-" . date("Y") : "") ?> <?= $_SERVER['appCompany']; ?>, All Rights Reserved.
                                                                </td>
                                                            </tr>
                                                            <tr>

                                                                <td align="center" class="MsoNormal" style="color:#666666; font-family:Segoe UI, Arial, Verdana, Trebuchet MS, sans-serif; font-size:14px; font-weight:300;  line-height:24px; letter-spacing:1px;">
                                                                    <a href="<?php echo base_url(); ?>" style="color:#666666; text-decoration:none;">
                                                                        <?= $_SERVER['appTitle']; ?> Home</a>
                                                                </td>
